...
public class Chat_combine extends AppCompatActivity {

    private RecyclerView recyclerView;
    private FirebaseDatabase db = FirebaseDatabase.getInstance();
    private DatabaseReference rootST= db.getReference().child("EIMS").child("Chat").child("Student");
   ...
   // private String date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_combine);
            ...
            public void onClick(View v) {
                ...
                rootST.push().setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        Toast.makeText(Chat_combine.this, "Sent!", Toast.LENGTH_SHORT).show();
                        finish();
