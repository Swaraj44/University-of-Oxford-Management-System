...
public class  Update_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name11 = findViewById(R.id.name34);
        email11 = findViewById(R.id.email34);
        mobile11 = findViewById(R.id.mobi34);
        dept11 = findViewById(R.id.dept34);
    ...
    public void add() {
        ...
        //Toast.makeText(SignUpForEveryone.this, "HHHHHHH", Toast.LENGTH_SHORT).show();



        //DatabaseReference rt = db.getReference().child("EIMS").child("USER").child(email).child(email)
        ...
        root.setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(Update_info.this, "Data Saved", Toast.LENGTH_SHORT).show();
            }
        });
    }
}